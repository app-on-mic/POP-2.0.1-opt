...
! !PUBLIC DATA MEMBERS:
   ...
   type (bndy), public :: &!  ghost cell update info
      ...
      bndy_capcg           ! block distribution for capcg solver in barotropic
...
!  setting in pop_in, by Junmin, Feb 1, 2016
...
!----------------------------------------------------------------------
   ...
   ! for thickened boundary update in CA-PCG solver used by barotropic
