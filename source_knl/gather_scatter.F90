...
!-----------------------------------------------------------------------
   ...
   call exit_POP(sigAbort,'gather_global_dbl_tiny:MIC is dst_task.')
     ...
     !*** copy local blocks
     do k=1,src_dist%local_block_num
         this_block = get_block(src_dist%local_block_ids(k),k)
...
!-----------------------------------------------------------------------
   ...
   !ljm tuning
   ! commented out by Junmin, Mar.11, 2016
...
!-----------------------------------------------------------------------
   ...
   ! commented out by Junmin, Mar.11, 2016
   !call exit_POP(sigAbort, 'scatter_global_int_tiny:MIC is NOT assumed to be sender')
     !*** send non-local blocks away
