...
! !DEFINED PARAMETERS:
   ...
   integer (int_kind), parameter, public :: &
      ...
      cacg_matlevel = 1  !cacg_sstep,     &! number of successvie matrix powers per boundary update
   ...
   integer (int_kind), parameter, public :: &
      nx_bkfactor = 3   ,&! size of macro-block(nx_bkfactor*nx_block,ny_bkfactor*ny_block)
      ny_bkfactor = 4     !  for cache blocking opt
