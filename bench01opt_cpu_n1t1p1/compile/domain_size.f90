...
! !DEFINED PARAMETERS:
   ...
   integer (int_kind), parameter, public :: &
      block_size_x = 60, &! size of block in first  horizontal dimension
   ...
   integer (int_kind), parameter, public :: &
      max_blocks_clinic = 48,  &! max number of blocks per processor
      max_blocks_tropic = 48    !   in each distribution
